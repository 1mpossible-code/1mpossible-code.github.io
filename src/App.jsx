...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝   ╚═╝   ╚═╝     ╚═╝`}
        ...
        <section id="skills" className="mx-auto w-full max-w-7xl px-6 py-24 sm:px-8 lg:px-10 lg:py-28">
          <div className="relative z-10">
            <div className="mb-12 max-w-3xl">
              <p className="sticky top-4 z-20 mb-4 inline-flex rounded-full border border-white/10 bg-black/55 px-4 py-2 text-sm uppercase tracking-[0.35em] text-white/55 backdrop-blur-md md:top-6">Skills</p>
              <h2 className="mt-4 text-3xl font-medium tracking-[-0.05em] text-white md:text-5xl">
                How the stack fits together.
              </h2>
              <p className="mt-4 max-w-2xl text-base leading-8 text-neutral-300">
                The strongest relationships in the stack sit around distributed systems, backend infrastructure, and ML tooling that has to run well in practice.
              </p>
            </div>
